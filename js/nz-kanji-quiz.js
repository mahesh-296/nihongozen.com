...
(function () {
  ...
  function buildQuestion(kanjiEntry) {
    ...
    var mc = (KQ.difficulty === 'easy') || qType === 'mean2kanji';
  ...
  /* ────────────────────────────────────────────────────────────
     6. Lightweight confetti burst (self-cleaning canvas overlay)
  ──────────────────────────────────────────────────────────── */
  function confettiBurst() {
    ...
    var colors = ['#FF4D7E', '#FFB454', '#7C4DD8', '#4CAF82', '#5B9BD5', '#E8446A'];
    var pieces = [];
    for (var i = 0; i < 90; i++) {
      pieces.push({
