...
(function(){
  ...
  /* ---- sound + best-score tracking (Quiz Menu UI removed;
     sound defaults on, best score is tracked silently in-session) ---- */
  let soundOn = true;
  let bestXP = 0;
  ...
  function confettiBurst(){
    /* Decorative confetti removed per UI/UX update. Correct-streak feedback
       now relies on the existing swipe/beep micro-interactions instead. */
  }
