...
(function () {
  ...
  *{box-sizing:border-box;}
  ...
  .chart-card h2{ font-size:22px; font-weight:800; color:#d8cfba; margin:0 0 4px 0;}
  ...
  .progress-pill .bar-outer{
    width:80px; height:6px; border-radius:6px; background:#e6ddc7; overflow:hidden;
  }
  ...
  .play-all:hover{background:var(--purple-deep);}
  ...
  .tab{
    ...
    color:#a39c8c; white-space:nowrap; transition:background .15s ease, color .15s ease;
  }
  .tab .en{
    display:block; font-family:"Nunito",sans-serif; font-size:10.5px; font-weight:700;
    color:#b3ac9c; margin-top:1px;
  }
  .tab.active{ background:#ffffff; color:var(--purple); box-shadow:0 2px 6px rgba(0,0,0,0.05);}
  ...
  .vowel-row{
    ...
    text-align:center; font-size:12px; font-weight:800; color:#c7bfab; margin-bottom:8px;
  }
  ...
  .tile-outer:hover .face.front{border-color:#AFA9EC;}
  ...
  .face.back .ex{font-size:9px; color:#534AB7; font-weight:700;}
  ...
  .note-card{
    ...
    margin-bottom:12px; overflow:hidden; box-shadow:0 6px 20px rgba(60,40,10,0.04);
  ...
  .note-body{ padding:0 18px 18px 18px; font-size:14px; line-height:1.65; color:#3d382f;}
  ...
  .xbox{ background:var(--purple-tint); border:1.5px solid #AFA9EC; border-radius:10px; padding:8px 13px; text-align:center; min-width:70px;}
  ...
  .quiz-btn{
    position:relative;
    display:inline-flex; align-items:center; gap:8px;
    background:linear-gradient(135deg, var(--purple) 0%, var(--purple-deep) 55%, #3D3690 100%);
    color:#fff; border:none; border-radius:30px;
    padding:11px 22px; font-size:14.5px; font-weight:800;
    font-family:"Nunito",sans-serif; cursor:pointer;
    box-shadow:0 6px 18px rgba(83,74,183,0.35), inset 0 1px 0 rgba(255,255,255,0.25);
    overflow:hidden;
  ...
  .quiz-btn:hover{ box-shadow:0 8px 24px rgba(83,74,183,0.5), inset 0 1px 0 rgba(255,255,255,0.3); }
  ...
  .play-now-btn{
    ...
    background:linear-gradient(135deg,var(--teal),#0d9a8b);
    color:#fff; border:none; border-radius:30px; width:100%;
    padding:16px 20px; font-size:17px; font-weight:900;
    font-family:"Nunito",sans-serif; cursor:pointer;
    box-shadow:0 10px 26px rgba(18,182,164,0.4);
    transition:transform .12s ease, box-shadow .12s ease;
    position:relative; overflow:hidden;
  }
  .play-now-btn:hover{ box-shadow:0 12px 30px rgba(18,182,164,0.55); transform:translateY(-1px); }
  .play-now-btn:active{ transform:scale(0.96); }

  .cfg-label{ font-size:11.5px; font-weight:800; text-transform:uppercase; letter-spacing:0.06em; color:#b3ac9c; margin:18px 0 8px 0; }
  ...
  .toggle-btn .en{ display:block; font-family:"Nunito",sans-serif; font-size:11px; font-weight:700; margin-top:3px; color:#b3ac9c;}
  ...
  .seg-btn{ flex:1; text-align:center; padding:9px 4px; border-radius:10px; cursor:pointer; font-size:12.5px; font-weight:700; color:#a39c8c; transition:all .15s ease;}
  .seg-btn.active{ background:#fff; color:var(--purple); box-shadow:0 2px 6px rgba(0,0,0,0.05);}
  ...
  .start-btn{
    ...
    padding:16px 20px; font-size:17px; font-weight:900;
    font-family:"Nunito",sans-serif; cursor:pointer;
    box-shadow:0 10px 26px rgba(83,74,183,0.4);
    transition:transform .12s ease, box-shadow .12s ease;
  }
  .start-btn:hover{ box-shadow:0 12px 30px rgba(83,74,183,0.55); transform:translateY(-1px); }
  .start-btn:active{ transform:scale(0.96); }

  .slide-menu-backdrop{
    position:fixed; inset:0; background:rgba(20,18,14,0.4); backdrop-filter:blur(3px);
  ...
  .menu-item .sw{ width:38px; height:20px; border-radius:20px; background:#e6ddc7; position:relative; flex-shrink:0; transition:background .15s ease;}
  ...
  .timer-ring.warn .fgc{ stroke:#e04a4a; }
  ...
  .flashcard{
    background:var(--tile); border-radius:24px; padding:36px 20px;
    display:flex; flex-direction:column; align-items:center; justify-content:center;
    width:100%; max-width:340px; min-height:220px; box-shadow:0 16px 34px rgba(0,0,0,0.2);
  ...
  .answer-input.correct{ border-color:var(--teal); background:#eafbf8; }
  .answer-input.incorrect{ border-color:#e04a4a; background:#fdeceb; }
  .submit-btn{
  ...
  .detail-hero{
    text-align:center; background:var(--tile); border-radius:22px;
    padding:30px 18px 22px 18px; margin:10px 0 18px 0;
    box-shadow:0 10px 30px rgba(60,40,10,0.10);
  }
  .detail-hero .kj{
    font-family:"Noto Sans JP",sans-serif; color:var(--tile-text);
  ...
  .detail-hero .say-btn.slow{ background:var(--tab-bg); color:var(--ink-soft); margin-left:8px; }
  .detail-hero .say-btn.slow:hover{ color:var(--purple); }
  .detail-hero .say-btn.speaking{ background:var(--teal); }

  .detail-desc{ font-size:14px; line-height:1.65; color:#3d382f; margin:0 0 4px 0; }

  .similar-row{ display:flex; flex-wrap:wrap; gap:8px; margin-top:4px; }
  .similar-chip{
    display:inline-flex; align-items:center; gap:6px;
    background:var(--purple-tint); border:1.5px solid #AFA9EC; border-radius:20px;
    padding:6px 12px 6px 10px; cursor:pointer; font-family:"Noto Sans JP",sans-serif;
    font-size:16px; font-weight:700; color:#423B7E;
  }
  .similar-chip:hover{ border-color:var(--purple); }
  .similar-chip .lbl{ font-family:"Nunito",sans-serif; font-size:10px; color:#534AB7; font-weight:800; }
  ...
  .word-play{
    ...
    background:var(--tile); color:var(--tile-text); border:none; cursor:pointer;
    display:flex; align-items:center; justify-content:center; font-size:11px;
  }
  .word-play.speaking{ background:var(--purple); }
  ...
  .empty-note{ font-size:12.5px; color:#b3ac9c; font-style:italic; padding:4px 2px; }

  /* ---------- Writing practice ---------- */
  .practice-card{
    background:var(--card); border:1px solid var(--line); border-radius:18px;
    padding:16px 16px 18px 16px; margin-top:8px; box-shadow:0 6px 20px rgba(60,40,10,0.04);
  }
  ...
  .trace-sw{ width:38px; height:20px; border-radius:20px; background:#e6ddc7; position:relative; flex-shrink:0; cursor:pointer; transition:background .15s ease; }
  ...
  .tool-btn.clear{ color:#e04a4a; }
  .tool-btn.clear:hover{ border-color:#e04a4a; color:#e04a4a; }
