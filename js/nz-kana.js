...
(function () {
  ...
  // ── STYLES (scoped under #kana-chart; dark theme colors) ────
  var CSS = `
  #kana-chart{
    --bg:#0B0C12;
    --bg-edge:#14151f;
    ...
    --purple:#FF4D7E;
    --purple-deep:#E8386A;
    --purple-tint:rgba(255,77,126,0.14);
    --teal:#4CAF82;
    --amber:#FFB454;
    --ink:#F2F2F8;
    --ink-soft:#8888AC;
  ...
  #kana-chart .legend b{color:var(--ink);}
  ...
  #kana-chart .sw-speak{background:var(--tile);}
  #kana-chart .sw-info{background:var(--purple);}
  #kana-chart .sw-learn{background:var(--teal);}
  ...
  #kana-chart .chart-card h2{ font-size:22px; font-weight:800; color:#33364a; margin:0 0 4px 0;}
  #kana-chart .chart-card .hint{ font-size:13.5px; color:var(--ink-soft); margin:0;}
  ...
  #kana-chart .progress-pill .bar-outer{
    width:80px; height:6px; border-radius:6px; background:#2A2D3D; overflow:hidden;
  }
  ...
  #kana-chart .play-all:hover{background:var(--purple-deep);}
  ...
  #kana-chart .search-wrap input:focus{border-color:var(--purple);}
  ...
  #kana-chart .tab{
    ...
    color:#8888AC; white-space:nowrap; transition:background .15s ease, color .15s ease;
  }
  #kana-chart .tab .en{
    display:block; font-family:"Nunito",sans-serif; font-size:10.5px; font-weight:700;
    color:#8888AC; margin-top:1px;
  }
  #kana-chart .tab.active{ background:#262A3C; color:var(--purple); box-shadow:0 2px 6px rgba(0,0,0,0.3);}
  #kana-chart .tab.active .en{color:var(--purple);}
  ...
  #kana-chart .vowel-row{
    ...
    text-align:center; font-size:12px; font-weight:800; color:#8888AC; margin-bottom:8px;
  }
  ...
  #kana-chart .face.front.speaking{background:var(--purple);}
  ...
  #kana-chart .face.front .rm{ color:var(--tile-rom); font-size:10.5px; margin-top:5px; font-weight:700;}
  ...
  #kana-chart .face.back .ex{font-size:9px; color:#FF4D7E; font-weight:700;}
  #kana-chart .face.back .ex .jp{font-size:11px;}

  #kana-chart .tile-outer.dim .face.front{opacity:0.22;}
  #kana-chart .tile-outer.match .face.front{outline:2px solid var(--teal); outline-offset:2px;}
  ...
  #kana-chart .info-btn{ bottom:-4px; right:-4px; background:var(--purple);}
  #kana-chart .learn-btn{ top:-4px; left:-4px; background:#3A3D4D;}
  #kana-chart .learn-btn.on{background:var(--teal);}

  #kana-chart .sub-label{
    font-size:11.5px; font-weight:800; text-transform:uppercase; letter-spacing:0.06em;
    color:#8888AC; margin:20px 0 8px 0; display:flex; align-items:center; gap:8px;
  }
  #kana-chart .sub-label:first-child{margin-top:2px;}
  #kana-chart .sub-label::after{content:''; flex:1; height:1px; background:var(--line);}

  #kana-chart .foot-note{ text-align:center; font-size:12px; color:#6B6E88; margin-top:16px; font-weight:600;}
  #kana-chart .no-results{ text-align:center; padding:30px 10px; color:var(--ink-soft); font-size:14px;}
  ...
  #kana-chart .notes-title{ font-size:22px; font-weight:900; color:var(--ink); margin:0;}
  ...
  #kana-chart .jump-pill:hover{border-color:var(--purple); color:var(--purple);}

  #kana-chart .note-card{
    background:var(--card); border:1px solid var(--line); border-radius:18px;
    margin-bottom:12px; overflow:hidden; box-shadow:0 6px 20px rgba(0,0,0,0.3);
  ...
  #kana-chart .note-body{ padding:0 18px 18px 18px; font-size:14px; line-height:1.65; color:#F2F2F8;}
  ...
  #kana-chart .accent{color:var(--purple); font-weight:800;}

  #kana-chart .xrow{ display:flex; align-items:center; gap:9px; flex-wrap:wrap; margin:13px 0;}
  #kana-chart .xbox{ background:var(--purple-tint); border:1.5px solid rgba(255,77,126,0.35); border-radius:10px; padding:8px 13px; text-align:center; min-width:70px;}
  #kana-chart .xbox .jp{font-size:19px; display:block; color:var(--ink);}
  #kana-chart .xbox .rm{font-size:10px; color:var(--ink-soft); margin-top:2px;}
  #kana-chart .arrow{color:var(--purple); font-weight:900; font-size:16px;}

  #kana-chart .wline{ display:flex; justify-content:space-between; align-items:center; padding:8px 0; border-bottom:1px dashed var(--line); gap:10px;}
  #kana-chart .wline:last-child{border-bottom:none;}
  #kana-chart .wline .jp{font-size:17px;}
  #kana-chart .wline .m{font-size:11.5px; color:var(--ink-soft); text-align:right;}

  #kana-chart table.tbl{width:100%; border-collapse:collapse; margin:11px 0; font-size:12.5px;}
  #kana-chart table.tbl th, #kana-chart table.tbl td{border:1px solid var(--line); padding:7px 8px; text-align:center;}
  #kana-chart table.tbl th{background:var(--tab-bg); font-weight:800;}
  #kana-chart table.tbl .big{font-size:17px;}

  #kana-chart .callout{ background:var(--purple-tint); border-left:3px solid var(--purple); padding:9px 13px; font-size:12.5px; border-radius:0 8px 8px 0; margin:11px 0;}
  ...
  .quiz-btn{
    position:relative;
    display:inline-flex; align-items:center; gap:8px;
    background:linear-gradient(135deg, var(--purple) 0%, var(--purple-deep) 55%, #B02050 100%);
  ...
  #kana-chart .quiz-close:hover{ color:var(--purple); border-color:var(--purple); }
  ...
  #kana-chart .quiz-hero p{ font-size:14px; color:var(--ink-soft); line-height:1.6; max-width:400px; margin:0 auto 18px auto; }
  ...
  #kana-chart .play-now-btn{
    ...
    background:linear-gradient(135deg,var(--teal),#2F8F5B);
  ...
  #kana-chart .cfg-label{ font-size:11.5px; font-weight:800; text-transform:uppercase; letter-spacing:0.06em; color:#8888AC; margin:18px 0 8px 0; }
  ...
  #kana-chart .toggle-btn .en{ display:block; font-family:"Nunito",sans-serif; font-size:11px; font-weight:700; margin-top:3px; color:#8888AC;}
  #kana-chart .toggle-btn.active{ border-color:var(--purple); background:var(--purple-tint); color:var(--purple); }
  #kana-chart .toggle-btn.active .en{ color:var(--purple); }

  #kana-chart .seg-row{ display:flex; background:var(--tab-bg); border-radius:14px; padding:4px; gap:2px; }
  #kana-chart .seg-btn{ flex:1; text-align:center; padding:9px 4px; border-radius:10px; cursor:pointer; font-size:12.5px; font-weight:700; color:#8888AC; transition:all .15s ease;}
  #kana-chart .seg-btn.active{ background:#262A3C; color:var(--purple); box-shadow:0 2px 6px rgba(0,0,0,0.3);}
  ...
  #kana-chart .menu-btn:hover{ color:var(--purple); border-color:var(--purple); }
  ...
  #kana-chart .menu-item:hover{ border-color:var(--purple); color:var(--purple); }
  #kana-chart .menu-item .sw{ width:38px; height:20px; border-radius:20px; background:#2A2D3D; position:relative; flex-shrink:0; transition:background .15s ease;}
  #kana-chart .menu-item .sw::after{ content:''; position:absolute; top:2px; left:2px; width:16px; height:16px; border-radius:50%; background:#fff; transition:left .15s ease; box-shadow:0 1px 3px rgba(0,0,0,.3);}
  #kana-chart .menu-item .sw.on{ background:var(--teal); }
  ...
  #kana-chart .stat-chip .v{ font-size:16px; font-weight:900; color:var(--ink); }
  #kana-chart .stat-chip .l{ font-size:9.5px; color:var(--ink-soft); font-weight:700; text-transform:uppercase; letter-spacing:.04em;}
  #kana-chart .stat-chip.streak .v{ color:var(--purple); }
  #kana-chart .stat-chip.xp .v{ color:var(--amber); }
  ...
  #kana-chart .timer-ring .bgc{ stroke:#2A2D3D; }
  #kana-chart .timer-ring .fgc{ stroke:var(--teal); stroke-linecap:round; transition:stroke-dashoffset 1s linear, stroke .2s ease; }
  #kana-chart .timer-ring .num{ position:absolute; inset:0; display:flex; align-items:center; justify-content:center; font-size:14px; font-weight:900; color:var(--ink); }
  #kana-chart .timer-ring.warn .fgc{ stroke:#E8446A; }
  ...
  #kana-chart .flashcard .kj{ font-family:"Noto Sans JP",sans-serif; color:var(--tile-text); font-size:clamp(48px,16vw,72px); line-height:1; }
  ...
  #kana-chart .answer-input:focus{ border-color:var(--purple); }
  #kana-chart .answer-input.correct{ border-color:var(--teal); background:rgba(76,175,130,0.15); }
  #kana-chart .answer-input.incorrect{ border-color:#E8446A; background:rgba(232,68,106,0.15); }
  ...
  #kana-chart .quit-link{ font-size:12.5px; color:var(--ink-soft); cursor:pointer; text-decoration:underline; }
  #kana-chart .quit-link:hover{ color:var(--purple); }

  #kana-chart .result-hero{ text-align:center; }
  #kana-chart .result-hero .big-xp{ font-size:40px; font-weight:900; color:var(--purple); margin:10px 0 2px 0; }
  #kana-chart .result-grid{ display:grid; grid-template-columns:1fr 1fr; gap:10px; margin:18px 0; }
  #kana-chart .result-card{ background:var(--card); border:1px solid var(--line); border-radius:14px; padding:12px; text-align:center; }
  #kana-chart .result-card .v{ font-size:20px; font-weight:900; }
  #kana-chart .result-card .l{ font-size:10.5px; color:var(--ink-soft); font-weight:700; text-transform:uppercase; }
  ...
  #kana-chart .detail-navbtn:hover{ color:var(--purple); border-color:var(--purple); }
  #kana-chart .detail-navbtn:disabled{ opacity:0.3; cursor:default; }
  #kana-chart .detail-navbtn:disabled:hover{ color:var(--ink-soft); border-color:var(--line); }
  ...
  #kana-chart .detail-hero .rm{ color:var(--tile-rom); font-size:16px; font-weight:800; margin-top:6px; }
  ...
  #kana-chart .detail-hero .say-btn:hover{ background:var(--purple-deep); }
  #kana-chart .detail-hero .say-btn:active{ transform:scale(0.96); }
  #kana-chart .detail-hero .say-btn.slow{ background:var(--tab-bg); color:var(--ink-soft); margin-left:8px; }
  #kana-chart .detail-hero .say-btn.slow:hover{ color:var(--purple); }
  #kana-chart .detail-hero .say-btn.speaking{ background:var(--teal); }

  #kana-chart .detail-desc{ font-size:14px; line-height:1.65; color:#F2F2F8; margin:0 0 4px 0; }

  #kana-chart .similar-row{ display:flex; flex-wrap:wrap; gap:8px; margin-top:4px; }
  #kana-chart .similar-chip{
    display:inline-flex; align-items:center; gap:6px;
    background:var(--purple-tint); border:1.5px solid rgba(255,77,126,0.35); border-radius:20px;
    padding:6px 12px 6px 10px; cursor:pointer; font-family:"Noto Sans JP",sans-serif;
    font-size:16px; font-weight:700; color:#FF4D7E;
  }
  #kana-chart .similar-chip:hover{ border-color:var(--purple); }
  #kana-chart .similar-chip .lbl{ font-family:"Nunito",sans-serif; font-size:10px; color:#FF4D7E; font-weight:800; }
  ...
  #kana-chart .word-card .wtext .m{ font-size:11.5px; color:var(--ink-soft); margin-top:2px; }
  #kana-chart .word-play{
    flex-shrink:0; width:32px; height:32px; border-radius:50%;
    background:var(--tile); color:var(--tile-text); border:none; cursor:pointer;
    display:flex; align-items:center; justify-content:center; font-size:11px;
  }
  #kana-chart .word-play.speaking{ background:var(--purple); }
  ...
  #kana-chart .sentence-card .rm{ font-size:11.5px; color:var(--purple); font-weight:700; margin-bottom:2px; }
  #kana-chart .sentence-card .en{ font-size:12px; color:var(--ink-soft); }
  #kana-chart .sentence-card .word-play{ margin-top:8px; }

  #kana-chart .empty-note{ font-size:12.5px; color:#8888AC; font-style:italic; padding:4px 2px; }

  #kana-chart /* ---------- Writing practice ---------- */
  .practice-card{
    background:var(--card); border:1px solid var(--line); border-radius:18px;
    padding:16px 16px 18px 16px; margin-top:8px; box-shadow:0 6px 20px rgba(0,0,0,0.3);
  }
  ...
  #kana-chart .trace-toggle-wrap{ display:flex; align-items:center; gap:8px; font-size:12.5px; font-weight:700; color:var(--ink-soft); }
  #kana-chart .trace-sw{ width:38px; height:20px; border-radius:20px; background:#2A2D3D; position:relative; flex-shrink:0; cursor:pointer; transition:background .15s ease; }
  #kana-chart .trace-sw::after{ content:''; position:absolute; top:2px; left:2px; width:16px; height:16px; border-radius:50%; background:#fff; transition:left .15s ease; box-shadow:0 1px 3px rgba(0,0,0,.3); }
  #kana-chart .trace-sw.on{ background:var(--teal); }
  ...
  #kana-chart .tool-btn:hover{ color:var(--purple); border-color:var(--purple); }
  #kana-chart .tool-btn:disabled{ opacity:0.4; cursor:default; }
  #kana-chart .tool-btn:disabled:hover{ color:var(--ink-soft); border-color:var(--line); }
  #kana-chart .tool-btn.save{ background:var(--purple); color:#fff; border-color:var(--purple); }
  #kana-chart .tool-btn.save:hover{ background:var(--purple-deep); color:#fff; }
  #kana-chart .tool-btn.clear{ color:#E8446A; }
  #kana-chart .tool-btn.clear:hover{ border-color:#E8446A; color:#E8446A; }
    ...
    <div class="detail-panel">
      ...
      <div class="detail-inner">
        ...
        <div class="detail-top">
          ...
          <span style="font-size:11.5px;font-weight:800;color:#8888AC;text-transform:uppercase;letter-spacing:.06em;" id="detailPosLabel"></span>
        ...
        <div class="practice-card">
          <div class="practice-toprow">
            ...
            <span style="font-size:11.5px;color:#8888AC;">Draw with mouse, touch, or stylus</span>
          </div>
