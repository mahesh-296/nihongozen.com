...
(function injectVocabStyles() {
  ...
  style.textContent = `
    ...
    /* ══════════════════════════════════════════════════════
       VOCAB REFERENCE CARD DESIGN
       (parchment / washi paper style — used for the per-word
       card in the vocab list AND the detail page, so both
       match exactly, per the reference design)
       ══════════════════════════════════════════════════════ */
    .nz-vcard-page {
      background:
        repeating-linear-gradient(0deg, rgba(120,100,70,0.06) 0px, rgba(120,100,70,0.06) 1px, transparent 1px, transparent 28px),
        repeating-linear-gradient(90deg, rgba(120,100,70,0.06) 0px, rgba(120,100,70,0.06) 1px, transparent 1px, transparent 28px),
        #ede4d3;
      border-radius: 18px;
      padding: 22px;
    }
    .nz-vcard-list { display:flex; flex-direction:column; gap:16px; }
    .nz-vcard {
      background:#faf5e8;
      border-radius:14px;
      padding:20px 22px;
    ...
    .nz-vcard:hover { transform:translateY(-2px); box-shadow:0 6px 18px rgba(60,45,20,0.16); }
    .nz-vcard.nz-vcard-playing { box-shadow:0 0 0 2px #b5824a; }
    .nz-vcard-head { display:flex; align-items:flex-start; gap:14px; }
    .nz-vcard-speak {
      flex-shrink:0; width:40px; height:40px; border-radius:50%;
      background:#e7dcc4; border:1px solid rgba(120,95,55,0.25);
      display:flex; align-items:center; justify-content:center;
      color:#7a5a33; cursor:pointer; transition:background .15s;
    }
    .nz-vcard-speak:hover { background:#dccfae; }
    .nz-vcard-speak.nz-vcard-speak-active { background:#b5824a; color:#fff; }
    .nz-vcard-num { font-family:var(--font-mono); font-size:13px; font-weight:700;
      color:#a5804f; margin-right:10px; }
    .nz-vcard-jp { font-family:var(--font-jp-sans); font-size:30px; font-weight:800;
      color:#3a2f22; display:inline; }
    .nz-vcard-kana { font-family:var(--font-jp-sans); font-size:17px; color:#8a7355;
      margin-left:10px; }
    .nz-vcard-romaji { font-family:var(--font-mono); font-size:13px; color:#8a7355;
      margin-top:2px; }
    .nz-vcard-en { font-family:Georgia,'Times New Roman',serif; font-style:italic;
      font-size:19px; color:#4a3d2c; margin-left:auto; text-align:right; padding-top:4px; }
    .nz-vcard-sentence {
      margin-top:16px; background:#e9dfc7; border-left:3px solid #b5824a;
      border-radius:8px; padding:14px 16px;
    }
    .nz-vcard-sentence-jp { font-family:var(--font-jp-sans); font-size:19px; color:#3a2f22;
      line-height:1.6; margin-bottom:6px; }
    .nz-vcard-sentence-kana { font-family:var(--font-jp-sans); font-size:14px; color:#8a7355;
      line-height:1.6; margin-bottom:6px; }
    .nz-vcard-sentence-romaji { font-family:var(--font-mono); font-size:13px; color:#5b6b63;
      line-height:1.6; margin-bottom:6px; }
    .nz-vcard-sentence-en { font-family:Georgia,'Times New Roman',serif; font-style:italic;
      font-size:16px; color:#4a3d2c; line-height:1.5; }
    .nz-vcard-generated-tag { font-size:10px; color:#a5804f; opacity:0.75; margin-top:8px;
      font-style:italic; }
    ...
    .nz-playall-btn, .nz-stopall-btn {
      ...
      font-size:13px; font-weight:700; font-family:inherit; cursor:pointer; border:1px solid;
      transition:opacity .15s, transform .15s;
    }
    .nz-playall-btn:hover, .nz-stopall-btn:hover { opacity:0.85; }
    .nz-playall-btn { background:#b5824a; border-color:#b5824a; color:#fff; }
    .nz-playall-btn:disabled { opacity:0.5; cursor:not-allowed; }
    .nz-stopall-btn { background:transparent; border-color:var(--border); color:var(--fg-muted); }
    .nz-stopall-btn:disabled { opacity:0.4; cursor:not-allowed; }
    ...
    .nz-vcard-detail-wrap .nz-vcard-jp { font-size:38px; }
    .nz-vcard-detail-wrap .nz-vcard-en { font-size:22px; }
    ...
    @media (max-width:560px){
      ...
      .nz-vcard-detail-wrap .nz-vcard-jp { font-size:30px; }
    }
  `;
