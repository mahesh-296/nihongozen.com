...
(function injectVocabStyles() {
  ...
  style.textContent = `
    ...
    .nz-vcard-en { font-family:var(--font-sans); font-style:italic;
      font-size:16px; color:var(--fg-muted); margin-left:auto; text-align:right; padding-top:4px; }
    .nz-vcard-sentence {
    ...
    @media (max-width:560px){
      .nz-vcard-head { flex-wrap:wrap; }
      .nz-vcard-en { margin-left:0; text-align:left; }
  ...
  function renderDetailScreen(area) {
    ...
    area.innerHTML = `
      ...
      <div class="nz-vcard-page nz-vcard-detail-wrap">
        <div class="nz-vcard" data-jp="${esc(word.jp)}">
          <div class="nz-vcard-head">
            <button class="nz-vcard-speak" id="vocab-detail-speak" aria-label="Play ${esc(word.jp)}">
              ${speakerIcon(18)}
            </button>
            <div style="flex:1;min-width:0;">
