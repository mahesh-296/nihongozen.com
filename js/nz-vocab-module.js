  ...
  N5: [
    {
      ...
      words: [
        ...
        { jp:'どういたしまして', romaji:'dōitashimashite', en:"you're welcome" },
        { jp:'失礼', romaji:'shitsurei', en:'excuse me' },
        { jp:'ごめんなさい', romaji:'gomennasai', en:"I'm sorry" },
        { jp:'大丈夫です', romaji:'daijōbu desu', en:"it's okay" },
        { jp:'お願い', romaji:'onegai', en:'please' },
        { jp:'もちろん', romaji:'mochiron', en:'certainly' },
        { jp:'こんにちは！', romaji:'konnichiwa!', en:'Hello! (formal)' },
        ...
        { jp:'運転免許証', romaji:'unten menkyoshō', en:'driving license' },
        { jp:'姓', romaji:'sei', en:'family name' },
        { jp:'国', romaji:'kuni', en:'country' },
        { jp:'身長', romaji:'shinchō', en:'height (person)' },
        { jp:'体重', romaji:'taijū', en:'weight (person)' },
        { jp:'年齢', romaji:'nen-ray', en:'age' },
      ]
    },
    {
      ch: 2, title: 'これはなんですか',
      ...
      words: [
        ...
        { jp:'画鋲', romaji:'gabyō', en:'thumbtack' },
        { jp:'ゼムクリップ', romaji:'zemu kurippu', en:'paper clip' },
        { jp:'糊', romaji:'nori', en:'glue' },
        { jp:'ホッチキス', romaji:'hochikisu', en:'stapler' },
        { jp:'パンチ', romaji:'panchi', en:'hole punch' },
        { jp:'鉛筆削り', romaji:'enpitsu kezuri', en:'pencil sharpener' },
        ...
        { jp:'どちらへ？', romaji:'dochira he?', en:'Where (to)?' },
        { jp:'どこから？', romaji:'doko kara?', en:'From where?' },
        { jp:'どちらの…？', romaji:'dochira no...?', en:'Which?' },
    ...
    },
    {
      ...
      words: [
        ...
        { jp:'薬局', romaji:'yakkyoku', en:'pharmacy/drugstore' },
        { jp:'ショッピングモール', romaji:'shoppingu mōru', en:'shopping mall' },
        { jp:'パン屋', romaji:'panya', en:'bakery' },
        { jp:'食料品店', romaji:'shokuryō hin ten', en:'grocery store' },
        { jp:'市場', romaji:'ichiba', en:'market' },
        { jp:'喫茶店', romaji:'kissaten', en:'coffee house' },
        { jp:'図書館', romaji:'toshokan', en:'library' },
        { jp:'博物館', romaji:'hakubutsukan', en:'museum' },
        { jp:'映画館', romaji:'eiga kan', en:'movie theater' },
        { jp:'学校', romaji:'gakkō', en:'school' },
        { jp:'大使館', romaji:'taishikan', en:'embassy' },
        { jp:'郵便局', romaji:'yūbinkyoku', en:'post office' },
    ...
    },
    {
      ...
      words: [
        ...
        { jp:'時間', romaji:'jikan', en:'hour' },
        { jp:'15分', romaji:'jū go fun', en:'quarter of an hour' },
        { jp:'日の出', romaji:'hinode', en:'sunrise' },
        { jp:'夜明け', romaji:'yoake', en:'dawn' },
        { jp:'早朝', romaji:'sōchō', en:'early morning' },
        { jp:'夕日', romaji:'yūhi', en:'sunset' },
        ...
        { jp:'公休', romaji:'kōkyū', en:'public holiday' },
        { jp:'一日中', romaji:'ichi nichi chū', en:'all day long' },
        { jp:'翌日', romaji:'yokujitsu', en:'next day' },
        { jp:'毎日', romaji:'mainichi', en:'every day' },
        { jp:'週', romaji:'shū', en:'week' },
        { jp:'先週', romaji:'senshū', en:'last week' },
        { jp:'来週', romaji:'raishū', en:'next week' },
        { jp:'週末', romaji:'shūmatsu', en:'weekend' },
        ...
        { jp:'遅過ぎます', romaji:'ososugimasu', en:'too late' },
        { jp:'少し遅れます', romaji:'sukoshi okuremasu', en:'I will be a little late' },
        { jp:'遅れてすみません', romaji:'okurete sumimasen', en:'sorry I am late' },
      ]
    },
    {
      ch: 5, title: 'いくらですか',
      ...
      words: [
        ...
        { jp:'為替レート', romaji:'kawase rēto', en:'exchange rate' },
        { jp:'ATM', romaji:'ētīemu', en:'ATM' },
        { jp:'コイン', romaji:'koin', en:'coin' },
        { jp:'ドル', romaji:'doru', en:'dollar' },
        { jp:'ユーロ', romaji:'yūro', en:'euro' },
        ...
        { jp:'試着室はどこですか', romaji:'shichakushitsu wa doko desu ka', en:'where is the fitting room?' },
        { jp:'このサイズは合いません', romaji:'kono saizu wa aimasen', en:'this size does not fit' },
        { jp:'似合いません', romaji:'niaimasen', en:'it does not suit me' },
        { jp:'絹', romaji:'kinu', en:'silk' },
        { jp:'木綿', romaji:'momen', en:'cotton' },
        { jp:'ウール', romaji:'ūru', en:'wool' },
        { jp:'おつり', romaji:'o tsuri', en:'change (give the)' },
        { jp:'支払い', romaji:'shiharai', en:'payment' },
      ]
    },
    {
      ...
      words: [
        ...
        { jp:'忘れる', romaji:'wasureru', en:'to forget' },
        { jp:'行く', romaji:'iku', en:'to go' },
        { jp:'持つ', romaji:'motsu', en:'to have' },
        { jp:'聞く', romaji:'kiku', en:'to hear' },
        { jp:'手伝う', romaji:'tetsudau', en:'to help' },
        { jp:'急ぐ', romaji:'isogu', en:'to hurry' },
        { jp:'笑う', romaji:'warau', en:'to laugh' },
        { jp:'開ける', romaji:'akeru', en:'to open' },
        { jp:'払う', romaji:'harau', en:'to pay' },
        { jp:'遊ぶ', romaji:'asobu', en:'to play' },
        { jp:'読む', romaji:'yomu', en:'to read' },
        { jp:'走る', romaji:'hashiru', en:'to run' },
        { jp:'見る', romaji:'miru', en:'to see' },
        { jp:'送る', romaji:'okuru', en:'to send' },
        { jp:'座る', romaji:'suwaru', en:'to sit down' },
        { jp:'話す', romaji:'hanasu', en:'to speak' },
        { jp:'泳ぐ', romaji:'oyogu', en:'to swim' },
        { jp:'取る', romaji:'toru', en:'to take' },
        { jp:'思う', romaji:'omō', en:'to think' },
        { jp:'待つ', romaji:'matsu', en:'to wait' },
        { jp:'書く', romaji:'kaku', en:'to write' },
        { jp:'到着する', romaji:'tōchaku suru', en:'to arrive' },
      ]
    },
    {
      ch: 7, title: 'なにをしますか',
      ...
      words: [
        ...
        { jp:'ほん', romaji:'hon', en:'book' },
        { jp:'掃除機', romaji:'sōji ki', en:'vacuum cleaner' },
        { jp:'洗濯機', romaji:'sentaku ki', en:'washing machine' },
        { jp:'カメラ', romaji:'kamera', en:'camera' },
        { jp:'ゲーム機', romaji:'gēmu ki', en:'video game console' },
        { jp:'リモコン', romaji:'rimokon', en:'remote control' },
        { jp:'DVDプレーヤー', romaji:'dībuidī purēyā', en:'DVD player' },
        { jp:'デジタルカメラ', romaji:'dejitaru kamera', en:'digital camera' },
      ]
    },
    {
      ...
      words: [
        ...
        { jp:'流ちょうに', romaji:'ryūchō ni', en:'fluently' },
        { jp:'語彙', romaji:'goi', en:'vocabulary' },
        { jp:'教科書', romaji:'kyōkasho', en:'textbook' },
        { jp:'なまり', romaji:'namari', en:'accent (language)' },
        { jp:'意味', romaji:'imi', en:'meaning' },
        { jp:'翻訳者', romaji:'honyaku sha', en:'translator' },
        ...
        { jp:'灰色の', romaji:'haīro no', en:'gray' },
        { jp:'金色の', romaji:'kiniro no', en:'golden' },
        { jp:'虹', romaji:'niji', en:'rainbow' },
        { jp:'水色の', romaji:'mizu iro no', en:'light blue' },
        { jp:'薄い', romaji:'usui', en:'light (color)' },
        { jp:'濃い', romaji:'koi', en:'dark (color)' },
        { jp:'鮮やかな', romaji:'azayaka na', en:'bright/vivid' },
      ]
    },
    {
      ...
      words: [
        ...
        { jp:'飛行機', romaji:'hikōki', en:'airplane' },
        { jp:'船', romaji:'fune', en:'ship' },
        { jp:'駅', romaji:'eki', en:'station' },
        { jp:'地下鉄', romaji:'chikatetsu', en:'subway' },
        { jp:'観光', romaji:'kankō', en:'tourism' },
        { jp:'観光客', romaji:'kankō kyaku', en:'tourist' },
        { jp:'旅行', romaji:'ryokō', en:'trip/voyage' },
        { jp:'休暇', romaji:'kyūka', en:'vacation' },
        ...
        { jp:'真っ直ぐ行ってください', romaji:'massugu itte kudasai', en:'go straight ahead' },
        { jp:'中心地', romaji:'chūshinchi', en:'city center' },
      ]
    },
    {
      ...
      words: [
        ...
        { jp:'山脈', romaji:'sanmyaku', en:'mountain range' },
        { jp:'頂上', romaji:'chōjō', en:'summit/top' },
        { jp:'断崖', romaji:'dangai', en:'cliff' },
        { jp:'丘', romaji:'oka', en:'hill' },
        { jp:'滝', romaji:'taki', en:'waterfall' },
        { jp:'風景', romaji:'fūkei', en:'landscape' },
        { jp:'泉', romaji:'izumi', en:'spring (source)' },
        { jp:'川岸', romaji:'kawagishi', en:'bank (of river)' },
        { jp:'湾', romaji:'wan', en:'gulf/bay' },
        { jp:'海岸', romaji:'kaigan', en:'shore' },
        { jp:'灯台', romaji:'tōdai', en:'lighthouse' },
        { jp:'市、町', romaji:'shi, machi', en:'city' },
        { jp:'首都', romaji:'shuto', en:'capital city' },
        { jp:'村', romaji:'mura', en:'village' },
        { jp:'中心街', romaji:'chūshin gai', en:'downtown' },
    ...
    },
    {
      ...
      words: [
        ...
        { jp:'鏡', romaji:'kagami', en:'mirror' },
        { jp:'カーペット', romaji:'kāpetto', en:'carpet' },
        { jp:'カーテン', romaji:'kāten', en:'drapes' },
        { jp:'枕', romaji:'makura', en:'pillow' },
        { jp:'毛布', romaji:'mōfu', en:'blanket' },
        { jp:'食堂', romaji:'shokudō', en:'dining room' },
        { jp:'書斎', romaji:'shosai', en:'study (home office)' },
        { jp:'玄関', romaji:'genkan', en:'entry room' },
        { jp:'家具', romaji:'kagu', en:'furniture' },
        { jp:'肘掛け椅子', romaji:'hijikake isu', en:'armchair' },
        { jp:'書棚', romaji:'shodana', en:'bookcase' },
        { jp:'棚', romaji:'tana', en:'shelf' },
        { jp:'ワードローブ', romaji:'wādo rōbu', en:'wardrobe' },
        { jp:'暖炉', romaji:'danro', en:'fireplace' },
        { jp:'引き出し', romaji:'hikidashi', en:'drawer' },
      ]
    },
    {
      ...
      words: [
        ...
        { jp:'靴クリーム', romaji:'kutsu kurīmu', en:'shoe polish' },
        { jp:'帽子', romaji:'bōshi', en:'hat' },
        { jp:'野球帽', romaji:'yakyū bō', en:'baseball cap' },
        { jp:'マフラー', romaji:'mafurā', en:'scarf/muffler' },
        { jp:'手袋', romaji:'tebukuro', en:'gloves' },
        { jp:'ネクタイ', romaji:'nekutai', en:'necktie' },
        { jp:'ベルト', romaji:'beruto', en:'belt' },
        { jp:'襟', romaji:'eri', en:'collar' },
        { jp:'ポケット', romaji:'poketto', en:'pocket' },
        { jp:'袖', romaji:'sode', en:'sleeve' },
        { jp:'チャック', romaji:'chakku', en:'zipper' },
    ...
    },
    {
      ...
      words: [
        ...
        { jp:'スーツケース', romaji:'sūtsukēsu', en:'suitcase' },
        { jp:'ガイドブック', romaji:'gaido bukku', en:'guidebook' },
        { jp:'ガイド', romaji:'gaido', en:'guide (person)' },
        { jp:'小旅行', romaji:'shō ryokō', en:'excursion' },
        { jp:'土産', romaji:'miyage', en:'souvenir' },
        { jp:'土産品店', romaji:'miyage hin ten', en:'gift shop' },
        { jp:'記念碑', romaji:'kinen hi', en:'monument' },
        { jp:'城', romaji:'shiro', en:'castle' },
        { jp:'写真に撮る', romaji:'shashin ni toru', en:'to take pictures' },
    ...
    },
    {
      ...
      words: [
        ...
        { jp:'比較する', romaji:'hikaku suru', en:'to compare' },
        { jp:'続ける', romaji:'tsuzukeru', en:'to continue' },
        { jp:'創造する', romaji:'sōzō suru', en:'to create' },
        { jp:'予約する', romaji:'yoyaku suru', en:'to reserve/book' },
        { jp:'言う', romaji:'iu', en:'to say' },
        { jp:'見せる', romaji:'miseru', en:'to show' },
        { jp:'勉強する', romaji:'benkyō suru', en:'to study' },
        { jp:'試みる', romaji:'kokoromiru', en:'to try' },
        { jp:'理解する', romaji:'rikai suru', en:'to understand' },
      ]
    },
    {
      ...
      words: [
        ...
        { jp:'十一月', romaji:'jūichigatsu', en:'November' },
        { jp:'十二月', romaji:'jūnigatsu', en:'December' },
        { jp:'季節', romaji:'kisetsu', en:'season' },
        { jp:'今月', romaji:'kongetsu', en:'this month' },
        { jp:'先月', romaji:'sengetsu', en:'last month' },
        { jp:'年', romaji:'nen', en:'year' },
        { jp:'毎年の', romaji:'maitoshi no', en:'annual' },
        { jp:'カレンダー', romaji:'karendā', en:'calendar' },
        { jp:'半年', romaji:'hantoshi', en:'half a year' },
        { jp:'日付', romaji:'hizuke', en:"date (today's)" },
        { jp:'全部で', romaji:'zenbu de', en:'in total' },
        { jp:'半分', romaji:'hanbun', en:'half' },
        { jp:'四分の一', romaji:'yonbun no ichi', en:'a quarter' },
        ...
        { jp:'十', romaji:'jū', en:'ten' },
        { jp:'百', romaji:'hyaku', en:'hundred' },
        { jp:'千', romaji:'sen', en:'thousand' },
        { jp:'一万', romaji:'ichiman', en:'ten thousand' },
        { jp:'第一の', romaji:'dai ichi no', en:'first' },
        { jp:'第二の', romaji:'dai ni no', en:'second' },
        { jp:'第三の', romaji:'dai san no', en:'third' },
      ]
    },
    {
      ...
      words: [
        ...
        { jp:'…の中に', romaji:'… no naka ni', en:'inside...' },
        { jp:'…の上に', romaji:'… no ue ni', en:'on top of...' },
        { jp:'ここです', romaji:'koko desu', en:'this is it / we are here' },
        { jp:'ちょっと待ってて下さい', romaji:'chotto mattete kudasai', en:'wait a minute please' },
    ...
    },
    {
      ...
      words: [
        ...
        { jp:'切手', romaji:'kitte', en:'stamp' },
        { jp:'小包み', romaji:'kozutsumi', en:'parcel' },
        { jp:'速達便', romaji:'sokutatsubin', en:'express mail' },
        { jp:'航空便', romaji:'kōkūbin', en:'airmail' },
        { jp:'書留', romaji:'kakitome', en:'registered mail' },
        { jp:'はがき', romaji:'hagaki', en:'postcard' },
        { jp:'封筒', romaji:'fūtō', en:'envelope' },
        { jp:'郵便切手', romaji:'yūbin kitte', en:'postage stamp' },
        { jp:'受け取る', romaji:'uketoru', en:'to receive' },
        { jp:'送り主', romaji:'okurinushi', en:'sender' },
        { jp:'受取人', romaji:'uketorinin', en:'receiver' },
      ]
    },
    {
      ...
      words: [
        ...
        { jp:'涼しくなります', romaji:'suzushiku narimasu', en:"it's cooling down" },
        ...
        { jp:'霜', romaji:'shimo', en:'frost' },
        { jp:'霧雨', romaji:'kirisame', en:'drizzle' },
        { jp:'霰', romaji:'arare', en:'sleet' },
    ...
    },
    {
      ...
      words: [
        ...
        { jp:'砂糖', romaji:'satō', en:'sugar' },
        { jp:'塩', romaji:'shio', en:'salt' },
        { jp:'米', romaji:'kome', en:'rice' },
        { jp:'バター', romaji:'batā', en:'butter' },
        { jp:'牛乳', romaji:'miruku', en:'milk' },
        { jp:'蜂蜜', romaji:'hachimitsu', en:'honey' },
        { jp:'マスタード', romaji:'masutādo', en:'mustard' },
        { jp:'醤油', romaji:'shoh-yu', en:'soy sauce' },
        { jp:'食べ物', romaji:'tabemono', en:'food' },
        { jp:'塩味の', romaji:'shioaji no', en:'salty' },
        { jp:'冷たい', romaji:'tsumetai', en:'cold' },
        { jp:'苦い', romaji:'nigai', en:'bitter' },
        { jp:'皮をむく', romaji:'kawa wo muku', en:'to peel' },
        { jp:'揚げる', romaji:'ageru', en:'to fry' },
        { jp:'沸かす', romaji:'wakasu', en:'to boil' },
        ...
        { jp:'前菜', romaji:'zensai', en:'appetizer' },
        { jp:'デザート', romaji:'dezāto', en:'dessert' },
        { jp:'食欲', romaji:'shokuyoku', en:'appetite' },
        { jp:'どうぞお召し上がり下さい！', romaji:'dōzo o meshiagarikudasai!', en:'Enjoy your meal!' },
        { jp:'スプーン', romaji:'supūn', en:'spoon' },
        { jp:'ナイフ', romaji:'naifu', en:'knife' },
        { jp:'フォーク', romaji:'fōku', en:'fork' },
        { jp:'ナフキン', romaji:'nafukin', en:'napkin' },
    ...
    },
    {
      ...
      words: [
        ...
        { jp:'祖父', romaji:'sofu', en:'grandfather' },
        { jp:'孫', romaji:'mago', en:'grandchildren' },
        { jp:'伯父', romaji:'oji', en:'uncle' },
        { jp:'伯母', romaji:'oba', en:'aunt' },
        { jp:'甥', romaji:'oi', en:'nephew' },
        { jp:'姪', romaji:'mei', en:'niece' },
        { jp:'妻', romaji:'tsuma', en:'wife' },
        { jp:'夫', romaji:'otto', en:'husband' },
        { jp:'子供', romaji:'kodomo', en:'child' },
        { jp:'親', romaji:'oya', en:'parents' },
        { jp:'弟', romaji:'otōto', en:'younger brother' },
        { jp:'姉', romaji:'ane', en:'elder sister' },
        { jp:'長男', romaji:'chōnan', en:'eldest son' },
        { jp:'長女', romaji:'chōjo', en:'eldest daughter' },
        { jp:'従兄弟/従姉妹', romaji:'itoko', en:'cousin' },
        { jp:'お母さん', romaji:'okāsan', en:'mom' },
        { jp:'お父さん', romaji:'otōsan', en:'dad' },
        { jp:'義父', romaji:'gifu', en:'father-in-law' },
        { jp:'赤ん坊', romaji:'akanbō', en:'baby' },
        { jp:'友情', romaji:'yūjō', en:'friendship' },
        { jp:'パートナー', romaji:'pātonā', en:'partner' },
        { jp:'隣人', romaji:'rinjin', en:'neighbor' },
        { jp:'同僚', romaji:'dōryō', en:'colleague' },
    ...
    },
    {
      ...
      words: [
        ...
        { jp:'病院', romaji:'byōin', en:'hospital' },
        { jp:'患者', romaji:'kanja', en:'patient' },
        { jp:'包帯', romaji:'hōtai', en:'bandage' },
        { jp:'体温計', romaji:'taionkei', en:'thermometer' },
        { jp:'インフルエンザ', romaji:'infuruenza', en:'influenza' },
        { jp:'ウィルス', romaji:'wirusu', en:'virus' },
        { jp:'予防接種', romaji:'yobō sesshu', en:'vaccination' },
        { jp:'風邪をひく', romaji:'kaze wo hiku', en:'to catch a cold' },
        { jp:'鼻水', romaji:'hanamizu', en:'runny nose' },
        { jp:'歯痛', romaji:'shitsū', en:'toothache' },
        { jp:'体温', romaji:'taion', en:'temperature (body)' },
        { jp:'脈拍', romaji:'myakuhaku', en:'pulse' },
        { jp:'くしゃみをする', romaji:'kushami wo suru', en:'to sneeze' },
        { jp:'打撲傷', romaji:'dabokushō', en:'bruise' },
        { jp:'出血', romaji:'shukketsu', en:'bleeding' },
        { jp:'火傷', romaji:'yakedo', en:'burn (injury)' },
        { jp:'医者', romaji:'isha', en:'doctor' },
        { jp:'診断', romaji:'shindan', en:'diagnosis' },
        { jp:'治療', romaji:'chiryō', en:'medical treatment' },
        { jp:'回復する', romaji:'kaifuku suru', en:'to recover' },
        { jp:'処方', romaji:'shohō', en:'prescription' },
        { jp:'錠剤', romaji:'jōzai', en:'tablet/pill' },
        { jp:'ばんそうこう', romaji:'bansōkō', en:'Band-Aid' },
        { jp:'痛み止め', romaji:'itami tome', en:'painkiller' },
        { jp:'歯医者', romaji:'ha-isha', en:'dentist' },
        ...
        { jp:'髪の毛', romaji:'kaminoke', en:'hair' },
        { jp:'手', romaji:'te', en:'hand' },
        { jp:'腕', romaji:'ude', en:'arm' },
        { jp:'指', romaji:'yubi', en:'finger' },
        { jp:'足', romaji:'ashi', en:'leg / foot' },
        { jp:'膝', romaji:'hiza', en:'knee' },
        { jp:'肩', romaji:'kata', en:'shoulder' },
        { jp:'腰', romaji:'koshi', en:'hip / waist' },
        { jp:'背中', romaji:'senaka', en:'back' },
        { jp:'胸', romaji:'mune', en:'chest' },
        { jp:'腹', romaji:'hara', en:'stomach' },
        { jp:'心臓', romaji:'shinzō', en:'heart' },
        { jp:'唇', romaji:'kuchibiru', en:'lips' },
        { jp:'頬', romaji:'hō', en:'cheek' },
        { jp:'額', romaji:'hitai', en:'forehead' },
        { jp:'肌', romaji:'hada', en:'skin' },
      ]
    },
    {
      ...
      words: [
        ...
        { jp:'皿', romaji:'sara', en:'plate' },
        { jp:'コップ', romaji:'koppu', en:'glass' },
        { jp:'カップ', romaji:'kappu', en:'cup' },
        { jp:'急須', romaji:'kyūsu', en:'teapot' },
        { jp:'おたま', romaji:'o tama', en:'ladle' },
        { jp:'ゴミ箱', romaji:'gomibako', en:'trash can' },
        ...
        { jp:'歯磨き粉', romaji:'hamigakiko', en:'toothpaste' },
        { jp:'歯ブラシ', romaji:'haburashi', en:'toothbrush' },
        { jp:'せっけん', romaji:'sekken', en:'soap' },
        { jp:'シャンプー', romaji:'shanpū', en:'shampoo' },
      ]
    },
    {
      ...
      words: [
        ...
        { jp:'離婚', romaji:'rikon', en:'divorced' },
        { jp:'身分証明書', romaji:'mibun shōmeisho', en:'identity card' },
        { jp:'電話', romaji:'denwa', en:'telephone' },
        { jp:'携帯電話', romaji:'keitai denwa', en:'mobile phone' },
        { jp:'電話する', romaji:'denwa suru', en:'to call' },
        { jp:'もしもし', romaji:'moshimoshi', en:'hello (phone)' },
        { jp:'インターネット', romaji:'intānetto', en:'internet' },
        { jp:'メール', romaji:'mēru', en:'email / text message' },
        { jp:'スマートフォン', romaji:'sumātofon', en:'smartphone' },
        { jp:'パスワード', romaji:'pasuwādo', en:'password' },
        { jp:'無線LAN', romaji:'musen LAN', en:'wi-fi' },
        { jp:'アプリ', romaji:'apuri', en:'app' },
        { jp:'ラップトップ', romaji:'rapputopu', en:'laptop' },
      ]
    },
    {
      ...
      words: [
        ...
        { jp:'部屋の予約をしてあります', romaji:'heya no yoyaku wo shite arimasu', en:'I have a room reservation' },
        { jp:'一泊はいくらですか', romaji:'ippaku wa ikura desu ka', en:'how much per night?' },
        { jp:'朝食付きですか', romaji:'chōshoku tsuki desu ka', en:'does it include breakfast?' },
        { jp:'エレベーターありますか', romaji:'erebētā arimasu ka', en:'is there an elevator?' },
        { jp:'ルームサービスありますか', romaji:'rūmu sābisu arimasu ka', en:'is there room service?' },
        { jp:'この部屋に決めました', romaji:'kono heya ni kimemashita', en:'I will take this room' },
        { jp:'航空券', romaji:'kōkū ken', en:'air ticket' },
        { jp:'チェックイン', romaji:'chekkuin', en:'check-in' },
        { jp:'出発ゲート', romaji:'shuppatsu gēto', en:'departure gate' },
        { jp:'乗り継ぎ', romaji:'noritsugi', en:'transit' },
        { jp:'見送る', romaji:'miokuru', en:'to see off' },
      ]
    },
    {
      ...
      words: [
        ...
        { jp:'オーストラリア', romaji:'ōsutoraria', en:'Australia' },
        { jp:'タイ', romaji:'tai', en:'Thailand' },
        { jp:'ベトナム', romaji:'betonamu', en:'Vietnam' },
        { jp:'宇宙', romaji:'uchū', en:'space / universe' },
        { jp:'星', romaji:'hoshi', en:'star' },
        { jp:'月', romaji:'tsuki', en:'moon' },
        { jp:'太陽', romaji:'taiyō', en:'sun' },
        { jp:'地球', romaji:'chikyū', en:'Earth' },
        { jp:'自然', romaji:'shizen', en:'nature' },
      ]
    },
  ],
