...
(function () {
  ...
  const CSS = `
    ...
    .kc-title { font-size: 22px; font-weight: 600; color: var(--fg); }
    .kc-subtitle { font-size: 13px; color: var(--fg-subtle); margin-top: 2px; }
    .kc-play-btn {
    ...
    .kc-play-btn:hover { background: var(--primary-hover); }
    .kc-play-btn:active { transform: scale(0.97); }
    .kc-play-btn.stopping { background: var(--danger); }
    ...
    .kc-tab.active  { background: var(--card); color: var(--primary); font-weight: 600; box-shadow: inset 0 -2px 0 var(--primary); }
    .kc-tab:hover:not(.active) { background: var(--bg-secondary); color: var(--fg-muted); }
    ...
    .kc-cell.active .kc-char { color: var(--primary); }
    .kc-rom {
      font-size: 10px;
      color: var(--fg-subtle);
      font-family: monospace;
    ...
    .kc-cell.active .kc-rom { color: var(--primary-hover); }
    .kc-sound-icon {
      position: absolute;
      top: 5px; right: 6px;
      font-size: 9px;
